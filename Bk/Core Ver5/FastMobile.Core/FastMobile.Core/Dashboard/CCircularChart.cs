...
{
    public class CCircularChart : FCircularChart
    {
        ...
        public CCircularChart(string controller) : base()
        {
        ...
        private async Task GetModel()
        {
            ...
            InitDataSource(Model.PieSeries);
        ...
        private async Task GetData()
        {
            ...
            InitDataSource(Model.PieSeries, !Model.RefreshOnChanging);
            RefreshFooter(false);
